"""
Django settings for mute_bird_4 project.
...
WSGI_APPLICATION = 'mute_bird_4.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mute_bird_4 API",
    "DESCRIPTION": "API documentation for mute_bird_4 App",
    "VERSION": "v1",
}
